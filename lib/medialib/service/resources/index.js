...
// The library is a special resource, because it does not have a corresponding entity within the media library.
...
exports.Library = {
   index: function( request, response ) {
      ...
      response.redirect( request.context.resourceSelfLink( virtualLibraryEntity ).url );
   },
