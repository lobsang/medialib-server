...
EntityMappingNode.prototype.map = function( mapping ) {
   this.resource.map( mapping.method, mapping.path, mapping.handler );
...
EntityMappingNode.prototype.boundPath = function( theEntities ) {
   ...
   // Extract the most specific route (using express-resource implementation detail)
   var path = ( Object.keys( this.resource.routes[ 'get' ] ) )[ 1 ];
