...
function createRequestContext( request, entityMappings, mediaLibrary )
{
   ...
   var resourceURL = function( entity ) {
      ...
      var path = entityMappings.resourcePath( entity );
      console.log( path );
      return baseURL + path;
   };
   ...
   return {
      ...
      resourceSelfLink: function( entity ) {
         ...
         // The resource self link is not dependent upon the current entity context (the stack of entities).
         // All resources are accessible directly under the library resource.
