...
MediaLibrary.prototype.createSongResponse = function( statusCode, songRecord ) {
   ...
   song.links.push( {
      rel : 'self',
      url : this.currentContext + '/' + songRecord.entityId
   } );
...
MediaLibrary.prototype.idForArtist = function( artist ) {
	return 'urn:artist:' + obfuscate( canonicalize( artist.name ) );
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////

MediaLibrary.prototype.idForSong = function( song ) {
	return 'urn:song:' + obfuscate( canonicalize( song.artist, song.album, song.title ) ); 
};
