...
var functionName = require( './functions' ).functionName;
...
/**
 * Returns a human readable representation of the type of the given object.
 * 
 * @example
 * actualTypeName( null )                           // Null
 * actualTypeName( undefined )                      // Undefined
 * actualTypeName( new String( 'Hello World' ) )    // String
 * actualTypeName( 'Hello World' )                  // String
 * actualTypeName( {} )                             // Object
 * actualTypeName( function() {} )                  // Function
 * actualTypeName( new MyType() )                   // MyType
 * actualTypeName( new( function() {} ) )           // Object
 */
function actualTypeName( object ) {
   var candidate = Object.prototype.toString.call( object ).match( /^\[object\s(.*)\]$/ )[ 1 ];
   
   if( candidate !== 'Object' ) {
      return candidate;
   }
   
   return functionName( object.constructor, 'Object' );
};
